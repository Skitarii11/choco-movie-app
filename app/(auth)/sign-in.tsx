...
import { appwrite, getCurrentUser, signIn } from "@/services/appwrite"; // You will add 'signIn' to this file
...
const SignIn = () => {
  ...
  const [forgotPasswordStep, setForgotPasswordStep] =
    useState<ForgotPasswordStep>("default");
        ...
        <View className="w-full justify-center min-h-[85vh] px-4 my-6">
          ...
          {forgotPasswordStep === "default" && (
            <>
              ...
              <TouchableOpacity
                onPress={() => setForgotPasswordStep("enterId")}
              ...
              <View className="justify-center pt-5 flex-row gap-2">
                <Text className="text-lg text-light-200">Бүртгэлгүй юу?</Text>
                <Link
                  href="/sign-up"
          ...
          {forgotPasswordStep === "enterId" && (
            <>
              <FormField
                ...
                handleChangeText={(e) =>
                  setResetForm({ ...resetForm, registrationId: e })
                }
                otherStyles="mt-7"
              ...
              <CustomButton
                title="Verify"
                handlePress={handleVerifyId}
                containerStyles="mt-7"
                isLoading={isSubmitting}
              />
              <TouchableOpacity
                onPress={() => setForgotPasswordStep("default")}
                className="mt-5"
              >
          ...
          {forgotPasswordStep === "enterNewPassword" && (
            <>
              <FormField
                ...
                handleChangeText={(e) =>
                  setResetForm({ ...resetForm, newPassword: e })
                }
                otherStyles="mt-7"
